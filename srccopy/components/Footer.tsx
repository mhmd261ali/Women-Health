...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        background: 'linear-gradient(135deg, #4A3530 0%, #3A2A26 50%, #2E3A2C 100%)',
      }}
    >
      {/* Top wave */}
      <div
        className="absolute top-0 left-0 right-0 h-1"
        style={{ background: 'linear-gradient(90deg, #D4756A, #8A9E84, #D4756A)' }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-xs mb-6">
              Dedicated to helping women feel stronger, healthier, and more confident through
              personalized training, physiotherapy, and holistic care.
            </p>
        ...
        >
          <span>
            ...
            © {new Date().getFullYear()} Dr. Sarah Wellness. All rights reserved.
          </span>
          <span className="flex items-center gap-1">
            Made with <Heart className="w-3 h-3 text-coral-400 fill-coral-400 inline mx-0.5" /> for women's health
          </span>
        </div>
      </div>
    </footer>
