    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          >
            Personal Trainer &nbsp;|&nbsp; Physiotherapist &nbsp;|&nbsp; Breastfeeding Specialist
          </motion.p>
          ...
          >
            {[
              ...
              <div key={stat.label}>
                ...
                <div className="text-xs text-sage-600 font-medium mt-0.5">{stat.label}</div>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        >
          ...
          >
            <div className="text-xs text-sage-600 font-medium">Specialized in</div>
            <div className="text-sm font-bold text-coral-600">Women's Health</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-sm font-bold text-sage-700">Recovery Expert</div>
          </motion.div>
        </motion.div>
      </div>
