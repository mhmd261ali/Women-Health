...
export default function BlogListing() {
  ...
  const getCategoryColor = (categoryId: string): string => {
    ...
    return category?.color || colorMap[category?.slug.current] || '#D4756A';
  };

  return (
    <section className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #FAF0EC 0%, #F4F6F3 100%)' }}>
      <div
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-sage-600 text-lg max-w-2xl mx-auto leading-relaxed">
            Expert articles on fitness, physiotherapy, postpartum recovery, breastfeeding, and
            holistic health — helping you make informed decisions about your wellbeing.
          </p>
        </motion.div>
                ...
                <div className="bg-white/70 backdrop-blur-sm">
                  ...
                  <div className="relative h-64 overflow-hidden bg-gradient-to-br from-coral-100 to-sage-100">
                    ...
                    <div
                      ...
                      style={{
                        background: 'linear-gradient(to top, rgba(138,158,132,0.3) 0%, transparent 60%)',
                      }}
                    />
                  </div>
